# the Signs of EGO protection
- Searching for new techniques to study 
- New easy ways to master something 
- 10 new Add- on to do the thing you need to do 
- not doing it to avoid seeing bad results . 
- Avoiding confusion 
- watching tutorials 
- Learning the fundamentals again and again in hope to master them 
- Big gap in recognition and reproduction 

# fixes
- delay the time before you use your lifeline 
- don't expect to change everything overnight 
- believe in yourself , dass du es schaffen kannst . 
